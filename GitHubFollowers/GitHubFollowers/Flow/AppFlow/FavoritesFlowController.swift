...
final class FavoritesFlowController: UIViewController {
    ...
    func start() {
        ...
        embeddedNavigationController.viewControllers = [favoritesVC]
    }
    
}

extension FavoritesFlowController: AppFlowControllerDelegate {
